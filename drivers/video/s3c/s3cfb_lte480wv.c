 ...
 *
 * $Id: s3cfb_lte480wv.c,v 1.13 2008/09/16 10:06:42 jsgood Exp $
 *
...
#define S3C_FB_LCD_PIXEL_CLOCK	(S3C_FB_VFRAME_FREQ * (S3C_FB_HFP + S3C_FB_HSW + S3C_FB_HBP + S3C_FB_HRES) * (S3C_FB_VFP + S3C_FB_VSW + S3C_FB_VBP + S3C_FB_VRES))
#define S3C_FB_PIXEL_CLOCK	(S3C_FB_VFRAME_FREQ * S3C_FB_LCD_PIXEL_CLOCK)
...
static void s3cfb_set_fimd_info(void)
{
	...
	s3c_fimd.lcd_pixclock = S3C_FB_LCD_PIXEL_CLOCK;
